...
# ================================================================
# Script de inicio para Sistema de Logística
...
PAGES_DIR="pages"
TARGET_DIR="pages_logistica"
MAIN_FILE="home_logistica.py"
PORT=8506
...
echo "===================================="
echo " Sistema de Logística - Agrivision"
echo "===================================="
echo ""
...
# ================================================================
echo -e "${BLUE}Configurando módulos de logística...${NC}"
ln -s "$TARGET_DIR" "$PAGES_DIR"

if [ -L "$PAGES_DIR" ]; then
    echo -e "${GREEN}✓ Módulos de logística activados${NC}"
else
...
echo -e "${GREEN}========================================${NC}"
echo ""
echo -e "📦 Aplicación: ${BLUE}Sistema de Logística${NC}"
