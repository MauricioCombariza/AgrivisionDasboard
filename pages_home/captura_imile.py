...
DB_HOST = os.getenv("DB_HOST_IMILE", "localhost")
DB_USER = os.getenv("DB_USER_IMILE", "root")
DB_PASS = os.getenv("DB_PASSWORD_IMILE")
DB_NAME = os.getenv("DB_NAME_IMILE", "imile")
...
def main():
    ...
    with st.expander("ℹ️ Información del Sistema"):
        ...
        st.write(f"**Usuario BD:** {DB_USER}@{DB_HOST}/{DB_NAME}")
